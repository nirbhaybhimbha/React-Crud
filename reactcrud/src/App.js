...
function App() {
  ...
  //  Edite.
  const edite = (indexx) => {
    const itemToEdit = array.find((item, index) => {
      return index === indexx;
    });
  ...
  return (
    <>
      <div
        style={{ padding: "100px", flexDirection: "column", display: "flex" }}
      >
          ...
          <tbody>
            {array.map((item, index) => (
              <tr key={index}>
                ...
                <td>{item.pasword}</td>
                <td>
                  <button type="submit" onClick={() => dilete(index)}>
                    Remove
                  </button>
                </td>
                <td>
                  <button type="submit" onClick={() => edite(index)}>
                    Edite
                  </button>
                </td>
              </tr>
